  ...
  return (
    <Card className="rounded-lg border overflow-hidden border-bg-dark" shadow="sm">
      ...
      <div className="relative p-2 pt-3">
        ...
        <span className="absolute top-[-1rem] right-2 text-[10px] text-dark bg-secondary py-0.5 px-1.5 rounded">45 Menit</span>
...
export const KuisStatusCard = () => {
  return (
    <Card className="rounded-lg border overflow-hidden border-bg-dark min-w-[144px]" shadow="sm">
